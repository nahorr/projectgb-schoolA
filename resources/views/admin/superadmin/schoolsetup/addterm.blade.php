...
@section('content')
                        ...
                        <div class="page-header">
                        	...
                        	<form class="form-group" action="{{ url('/schoolsetup/postterm') }}" method="POST">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="widget-box">
                                                <div class="widget-header">
                                                    <h4 class="widget-title">Add Term for {{$schoolyear->school_year}} School Year </h4>
                                                    <span class="widget-toolbar">
                                                        <a href="{{asset('/schoolsetup/showterms')}}">
                                                ...
                                                <div class="widget-body">
                                                    ...
                                                    <label for="school-year">Term </label>
                                                        ...
                                                        <li><label for="show_until">If term is 3rd Term, set to at least 5-6 years from end date</label></li>
                                                        </ul>
                                                        <div class="row">
                                                            <div class="col-xs-8 col-sm-11">
                                                                <div class="input-group">
