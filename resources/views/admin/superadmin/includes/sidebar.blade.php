                ...
                <ul class="nav nav-list">
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li >
                                <a href="{{ url('/schoolsetup/showterms') }}">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    View Terms
                                </a>
                            ...
                            <li >
                                <a href="{{ url('/schoolsetup/addterm') }}">
                                    <i class="menu-icon fa fa-caret-right"></i>
                                    Add a term
                                </a>
                    ...
                    <li {{{ (Request::is('schoolsetup/showcoursesterms') ? 'class=active' : '') }}}>
                        <a href="{{ url('/schoolsetup/showcoursesterms') }}">
