...
Route::get('/students/discipline/allstudents', 'AdminAuth\Students\Discipline\CrudeController@allStudents');
Route::get('/students/discipline/{student}', 'AdminAuth\Students\Discipline\CrudeController@student');
...
Route::group(['middleware' => 'superadmin'], function () {  
    ...
    Route::get('/schoolsetup/showschoolyear', 'AdminAuth\SchoolYearSetUpController@showSchoolYear');
    ...
    Route::get('/schoolsetup/showterms', 'AdminAuth\TermSetUpController@showTerms');
    Route::get('/schoolsetup/addterm', 'AdminAuth\TermSetUpController@addTerm');
    Route::post('/schoolsetup/postterm', 'AdminAuth\TermSetUpController@postTerm');
    Route::get('/schoolsetup/editterm/{term}', 'AdminAuth\TermSetUpController@editTerm');
    ...
    Route::get('/schoolsetup/showcoursesterms', 'AdminAuth\CourseSetUpController@showCoursesTerms');
    Route::get('/schoolsetup/showcoursesgroups/{term}', 'AdminAuth\CourseSetUpController@showCoursesGroups');
    Route::get('/schoolsetup/showcourses/{term}/{group}', 'AdminAuth\CourseSetUpController@showCourses')->name('showcourses');
    Route::get('/schoolsetup/addcourse/{term}/{group}', 'AdminAuth\CourseSetUpController@addCourse');
    Route::post('/schoolsetup/postcourse/{term}/{group}', 'AdminAuth\CourseSetUpController@postCourse');
    Route::get('/schoolsetup/editcourse/{course}/{term}/{group}', 'AdminAuth\CourseSetUpController@editCourse');
    ...
    Route::get('/schoolsetup/students/showstudents/{group}', 'AdminAuth\Students\SetUpController@showStudents')->name('showstudents');
