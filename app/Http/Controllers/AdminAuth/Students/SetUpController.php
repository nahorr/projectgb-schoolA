...
class SetUpController extends Controller
{
    public function showGroups()
    {
        ...
        return view('/admin.superadmin.schoolsetup.students.showgroups', compact('today', 'teacher', 'teacher_logged_in', 'schoolyear', 'groups'));
    }
    ...
    public function showStudents($group_id)
    {
        ...
        return view('/admin.superadmin.schoolsetup.students.showstudents', compact('today', 'teacher', 'teacher_logged_in', 'schoolyear', 'students', 'group', 'students_count'));
    }
